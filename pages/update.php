...
<div class="container">
    <form action="../connection/action.php" method="post">
        ...
        <input id="lesson" type="text" name="lesson" placeholder="Lesson" value="<?php echo $data["lesson"]; ?>" required>
        <textarea wrap="soft" rows="15" name="explanation" placeholder="Explanation" required><?php echo $data["explanation"]; ?></textarea>
